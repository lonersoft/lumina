...
class Permissions {
    ...
    public static getAll(): Array<{ constant: string; value: string; category: string; description: string }> {
        return [
            ...
            { constant: 'ADMIN_J4R_SERVERS_CREATE', value: Permissions.ADMIN_J4R_SERVERS_CREATE, category: 'Admin J4R Servers', description: 'Create new J4R (Join for Rewards) servers' },
            { constant: 'ADMIN_J4R_SERVERS_EDIT', value: Permissions.ADMIN_J4R_SERVERS_EDIT, category: 'Admin J4R Servers', description: 'Edit existing J4R (Join for Rewards) servers' },
            { constant: 'ADMIN_J4R_SERVERS_DELETE', value: Permissions.ADMIN_J4R_SERVERS_DELETE, category: 'Admin J4R Servers', description: 'Delete J4R (Join for Rewards) servers' },
            { constant: 'ADMIN_J4R_SERVERS_LIST', value: Permissions.ADMIN_J4R_SERVERS_LIST, category: 'Admin J4R Servers', description: 'List all J4R (Join for Rewards) servers' },
            ...
            { constant: 'ADMIN_MAIL_SEND_MASS_MAIL', value: Permissions.ADMIN_MAIL_SEND_MASS_MAIL, category: 'Admin Mail', description: 'Send mass mails to all users!' },
            ...
            { constant: 'USER_PERMISSION_VIP', value: Permissions.USER_PERMISSION_VIP, category: 'VIP', description: 'The VIP permission that allows you to create servers on vip eggs or nodes' },
            { constant: 'ADMIN_IMAGE_REPORTS_VIEW', value: Permissions.ADMIN_IMAGE_REPORTS_VIEW, category: 'Admin Image Reports', description: 'View image reports' },
            { constant: 'ADMIN_IMAGE_REPORTS_LIST', value: Permissions.ADMIN_IMAGE_REPORTS_LIST, category: 'Admin Image Reports', description: 'List image reports' },
            { constant: 'ADMIN_IMAGE_REPORTS_EDIT', value: Permissions.ADMIN_IMAGE_REPORTS_EDIT, category: 'Admin Image Reports', description: 'Edit image reports' },
            { constant: 'ADMIN_IMAGE_REPORTS_DELETE', value: Permissions.ADMIN_IMAGE_REPORTS_DELETE, category: 'Admin Image Reports', description: 'Delete image reports' },
            { constant: 'USER_PERMISSION_BYPASS_ADBLOCKER', value: Permissions.USER_PERMISSION_BYPASS_ADBLOCKER, category: 'Adblocker', description: 'The permission that lets you bypass the antiadblocker!' },
            { constant: 'USER_PERMISSION_BYPASS_ALTING', value: Permissions.USER_PERMISSION_BYPASS_ALTING, category: 'AntiAlting', description: 'This permissions bypasses the system that does alt checks!' },
            { constant: 'USER_PERMISSION_BYPASS_VPN', value: Permissions.USER_PERMISSION_BYPASS_VPN, category: 'AntiVPN', description: 'This permission does a full bypass of the antivpn system!' },
        ];
    }
}
